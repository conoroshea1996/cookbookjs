<div class="flex flex-no-wrap">
  ...
  >
    <div class="px-8">
      <div class="h-16 w-full w-full flex justify-center items-center">
        <h1 class="text-gray-100 italic text-4xl">Docx</h1>
      </div>
      <ul class="mt-12">
        <li
        ...
        <li
          class="flex w-full justify-between text-gray-500 hover:text-gray-400 cursor-pointer items-center mb-6"
        >
          <div class="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li
          class="flex w-full justify-between text-gray-500 hover:text-gray-400 cursor-pointer items-center"
        >
          <div class="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
